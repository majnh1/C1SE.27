...
class FoodieAppBar2 extends StatefulWidget implements PreferredSizeWidget {
  FoodieAppBar2({
    super.key,
    this.leftPressed,
    Icon? icon,
  ...
  @override
  State<FoodieAppBar2> createState() => _FoodieAppBar2State();

  @override
  Size get preferredSize => const Size.fromHeight(86.0);
}

class _FoodieAppBar2State extends State<FoodieAppBar2> {
